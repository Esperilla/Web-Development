...
// API simulada para desarrollo sin base de datos
app.use('/api/auth', (req, res, next) => {
    res.json({
        success: false,
        message: 'Base de datos no configurada. Por favor, configura MySQL y reinicia el servidor.'
    });
});
...
app.get('/api/health', (req, res) => {
    res.json({
        success: true,
        message: 'Servidor ICTAM WebApp funcionando correctamente (Modo desarrollo - Sin base de datos)',
...
function startServerWithoutDB() {
    ...
    app.listen(PORT, () => {
        console.log('🏢 ICTAM WebApp Server (Modo desarrollo)');
        ...
        console.log('   1. Instala MySQL');
        console.log('   2. Ejecuta: mysql -u root -p < setup_database.sql');
        console.log('   3. Configura DB_PASSWORD en .env');
        console.log('   4. Renombra server-dev.js a server.js');
        console.log('🚀 =========================================');
    });
}
